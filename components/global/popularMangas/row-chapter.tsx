    ...
    <div className="flex flex-row items-center max-w-[240px]">
      <div className=" basis-1/2">
        <Link
          ...
          className="px-2 py-1 text-sm font-bold text-gray-200 transition-colors bg-gray-100 rounded-lg dark:bg-neutral-700 dark:text-neutral-400 dark:hover:bg-main-green dark:hover:text-white max-w-fit hover:bg-main-green hover:text-white shrink-0"
        >
