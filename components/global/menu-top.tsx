      ...
      <div className="w-full bg-main-green">
        <div className="py-4 xl:max-w-[1200px] lg:max-w-[940px] mx-auto">
          <div className="flex flex-row items-center px-5">
            ...
            <div className="block cursor-pointer grow md:hidden" onClick={() => {
            ...
            <div className="flex flex-row gap-x-1 lg:gap-x-2">
              ...
              <button
                className="px-2 text-sm font-semibold text-white transition-colors rounded-full hover:bg-black"
