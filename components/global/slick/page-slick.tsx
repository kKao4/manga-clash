...
export default function PageSlick({ manga }: { manga: MangaResponse["data"] }) {
  return (
    <div className="w-screen sm:w-[572px] lg:w-[580px] h-[250px] relative overflow-hidden">
      ...
      <div className="absolute w-full h-full pl-2 pr-3 sm:px-8 py-4 sm:py-6 z-10 flex flex-row">
        <div className="flex-1">
          ...
          <div className="flex flex-row gap-x-2 items-center mb-0.5">
            ...
            <div className="relative max-w-fit flex-none">
              <svg className="h-12 fill-main-yellow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z" /></svg>
            ...
            <div className="flex flex-col -mb-1">
              <p className="text-white text-xl font-medium uppercase line-clamp-1 pr-4 sm:pr-12 hover:text-main-green transition-colors duration-300 ease-out cursor-pointer">{manga?.name}</p>
          ...
          <div className="px-2.5">
            {manga!.tags.length ? (
              <div className="line-clamp-1 pr-4 sm:pr-24 mb-2.5">
            ...
            <p className="text-[13px] text-neutral-200 line-clamp-2 sm:pr-6 mb-1">{manga?.description ? manga?.description : "Đang cập nhật"}</p>
            <div>
        ...
        <div className="flex-none">
          <Image className="max-w-[75px] sm:max-w-[100px]" src={manga!.image.url} alt="" width={100} height={144} />
        </div>
      </div>
    </div>
  )
