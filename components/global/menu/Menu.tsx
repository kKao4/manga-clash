      ...
      <div className="w-full bg-main-green">
        <div className="py-3 xl:max-w-[1200px] lg:max-w-[940px] mx-auto">
          <div className="flex flex-row items-stretch px-5 md:items-center">
            ...
            >
              <Link href="/" className="relative mr-auto max-w-[180px] max-h-[32px] md:max-h-[44px] overflow-hidden flex justify-center items-center xl:mr-12 drop-shadow-md">
            ...
            <div className="flex flex-row gap-x-1.5 lg:gap-x-2">
              ...
              <motion.div
                ...
                whileTap={{ scale: 0.88 }}
              >
                <button className="flex items-center justify-center mr-auto w-8 h-8 transition-colors bg-white rounded-full group hover:bg-black overflow-hidden relative" onClick={() => toggle()}>
