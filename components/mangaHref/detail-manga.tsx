...
export default function DetailManga({ manga, chapters }: { manga: MangaType, chapters: MangaType["chapters"] | undefined }) {
          ...
          <div className="flex flex-row">
            ...
            <div className="flex flex-col basis-1/2 gap-y-3">
              ...
              {bookmark ? (
                ...
                <p className="text-sm text-center select-none">{manga.bookmarks} người dùng đã thích truyện</p>
              )}
            </div>
          </div>
        </div>
