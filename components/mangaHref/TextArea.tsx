...
export default function TextArea({ mangaState, description, setDescription }: { mangaState?: typeof initialMangaState[number], description: string, setDescription: Dispatch<SetStateAction<string>> }) {
  ...
  return (
    <div>
      ...
      <textarea
        name="description"
        className={`w-full px-3 pb-3 border border-neutral-400 dark:border-transparent dark:bg-neutral-700 border-t-transparent rounded-b focus:outline-none min-h-[240px] mt-0`}
        value={description}
