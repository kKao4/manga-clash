...
export default function ImageManga({
  handleOnChange, mangaUrl, mangaState
}: {
  handleOnChange: (e: any) => void, mangaUrl: string, mangaState: typeof initialMangaState[number]
}) {
