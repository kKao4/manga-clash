  ...
  return (
    <>
      <div className="flex flex-row items-center transition-colors" onClick={handleOnClick}>
        <button className={`${isActive ? "bg-second-green text-white dark:text-neutral-100" : "bg-gray-150 dark:bg-neutral-750 hover:text-second-green dark:hover:text-main-green"} flex flex-row items-center px-4 py-3.5 font-bold basis-full gap-x-3 group`}>
          {children}
        </button>
