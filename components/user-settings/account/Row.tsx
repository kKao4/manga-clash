    ...
    <form className="py-2 pb-4 border-b dark:border-neutral-700" onSubmit={(e) => handleOnSubmit(e)}>
      ...
      <div>
        <motion.button
          whileTap={{ scale: 0.95 }}
          type="submit"
          className={`${valid ? "bg-second-green" : "bg-red-500"} ${isLoading ? "" : "hover:bg-black"} rounded-2xl mx-auto block transition-colors text-white font-bold px-4 py-1.5 text-sm`}
