...
export default function NavChapter({
  ...
  return (
    <div className="fixed bottom-0 z-20 w-full">
      <div className=" w-full h-6 bg-black/70 flex justify-center items-center">
        <div className="w-[960px] bg-main-green h-1.5" />
      </div>
          ...
          <div className="flex items-center justify-center basis-1/4">
            <div className="relative w-full h-full overflow-hidden">
              <select
                ...
                className="w-full h-full px-0 py-2 text-base text-white transition-colors rounded-md select-none sm:px-2 text-ellipsis md:px-4 md:text-lg bg-neutral-700 focus:outline-none" id="select-chapter"
