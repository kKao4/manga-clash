  ...
  return (
    <>
      <div className="relative max-w-fit">
        ...
        {/* delete modal */}
        <div className={`${isOpenDeleteModal ? "scale-100 -translate-y-full opacity-100" : "scale-0 -translate-y-1/2 translate-x-1/2 opacity-0"} transition-all duration-200 absolute right-0 -top-1 w-[170px] h-[75px] rounded-md grid place-content-evenly bg-white`}>
          ...
          >
            ...
            <button
              type="submit"
              className={`${isDeletingChapter ? "bg-red-600 text-white/80" : "bg-red-500 opacity-100 hover:bg-red-600"} px-2 py-1 font-semibold text-white rounded`}
