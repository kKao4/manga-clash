...
export default function ButtonGuide() {
  ...
  return (
    <div className="fixed left-4 bottom-5 rounded-full flex flex-row items-center">
      ...
      <motion.div initial={{ x: -80, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 1, delay: 1.5, type: "spring" }} className="px-2 py-1 bg-main-green text-neutral-100 -ml-2 rounded pl-3">
        Giới thiệu
      </motion.div>
    </div>
  )
